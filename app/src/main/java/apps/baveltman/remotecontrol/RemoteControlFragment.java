...
/**
 * Created by borisvelt on 3/19/15.
 */
public class RemoteControlFragment extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup parent, Bundle savedInstanceState) {
        ...
        //onclick listener to be used for multiple click events on numbered buttons
        ...
        //dynamically set button text and event listeners
